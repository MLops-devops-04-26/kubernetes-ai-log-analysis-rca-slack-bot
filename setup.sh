...
# Install Loki
 ...
 helm install loki grafana/loki   --version 6.27.0   -n monitoring   -f monitoring/loki-values.yaml
...
#port-forwding all the apps 
kubectl apply -f k8s-tunnels-deployment.yaml
...
echo "GraURfana L: http://localhost:3000"
